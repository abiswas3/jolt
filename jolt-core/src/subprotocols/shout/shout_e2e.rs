...
//impl<F> CacheSumcheckOpenings<F> for ShoutSumcheck<F>
//where
//    F: JoltField,
//{
//    fn cache_openings_prover(
//        &mut self,
//        _accumulator: Option<Rc<RefCell<ProverOpeningAccumulator<F>>>>,
//        _opening_point: OpeningPoint<BIG_ENDIAN, F>,
//    ) {
...
//impl<F> CacheSumcheckOpenings<F> for BooleanitySumcheck<F>
//where
//    F: JoltField,
//{
//    fn cache_openings_prover(
